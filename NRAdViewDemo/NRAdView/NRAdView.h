...
#import "NRAdViewRenderDelegate.h"

///将builder的LINE_SPACING设置为该值则会自动计算合适的间距
#define SC_BUILDER_LINE_SPACING_AUTO -10001
typedef NS_ENUM(NSInteger,NRAdViewScrollDirection) {
    NRAdViewScrollDirectionRight = 0,//轮播向右
    NRAdViewScrollDirectionLeft,//轮播向左
    NRAdViewScrollDirectionBotom,//轮播向下
    NRAdViewScrollDirectionTop,//轮播向上
};
@interface NRAdViewBuilder : NSObject
#pragma mark -必要参数
/**
 *   必填：广告模型数组
 */
 ...
 */
@property (nonatomic,assign)NRAdViewScrollDirection autoScrollDirection;
/**
 *   最小item间距
 */
...
@protocol NRAdViewRenderDelegate;

@protocol NRAdViewDelegate <NSObject>
/**
 *  @brief 滑动到的广告的index
 */
